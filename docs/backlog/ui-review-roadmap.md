...
- P6a. Airtable grid 网格编辑复刻 — 分析与静态复刻: `planned`（plan `docs/plans/2026-08-30-0614-2-p6a-airtable-grid-static-replica.md`，2026-08-30 review 通过转 active；执行时序受虚线 P5b -.-> P6a 约束）
