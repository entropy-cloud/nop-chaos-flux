...
所有子项已按 Phase Status 标注收口。详情见各子项的 closure plan。condition-builder async metadata loading 因违反「请求必须下沉」原则被废弃（`docs/bugs/15-component-level-initfetch-analysis-and-fix.md`）。**本 roadmap 无待实现项残留。**
