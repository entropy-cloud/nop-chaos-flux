...
> 制定日期: 2026-03-29
> 基于: `docs/analysis/2026-03-21-framework-debugger-design.md` 设计草案
> 状态: 已完成
...
3. **CSS 新增**:
   ...
   .nop-debugger__json-key {
     color: #9bd9ff;
   }
   .nop-debugger__json-string {
     color: #9df3ca;
   }
   .nop-debugger__json-number {
     color: #ffd18a;
   }
   .nop-debugger__json-boolean {
     color: #dcc0ff;
   }
   .nop-debugger__json-null {
...
| 锚点            | 路径                                                    | 说明                        |
| --------------- | ------------------------------------------------------- | --------------------------- |
| 设计草案        | `docs/analysis/2026-03-21-framework-debugger-design.md` | 全部设计目标                |
