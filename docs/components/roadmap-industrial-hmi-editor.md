...
- **E0. 三项 spike 验证** (`todo`) <!-- viewport+Editor 共存手势仲裁 / Editor 事件族载荷 / 编辑态覆盖物密集场景性能；scratch 目录 ~/sources/industrial-hmi-research/spike-editor/；2026-08-05 立项 -->
...
_（空——本 mission 为首版起草，尚无 audit / plan 收口产生 follow-up。后续 plan / audit / review gate 收口时按 industrial-hmi runtime mission 先例登记：source + 描述 + 建议 + 收口标记）_
