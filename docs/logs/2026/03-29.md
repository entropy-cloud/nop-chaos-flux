...
- Updated architecture docs: `renderer-markers-and-selectors.md` (testid convention, priority table), `component-resolution.md` (identity table), `renderer-runtime.md` (meta contract).
...
- Ref: `docs/architecture/renderer-markers-and-selectors.md`, `docs/architecture/component-resolution.md`
