...
3. `submitForm` 是语义型 form submit command，不要求业务 payload；`formId` 是当前支持的 cross-form targeting carrier，若要更明确地指定目标 form，优先使用 `component:submit` 与 targeting
