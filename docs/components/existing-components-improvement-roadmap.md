...
> Last Updated: 2026-06-22 (E3 P2 text maxLine toggle + icon size token residuals closed — `maxLineToggle` + 溢出检测 + a11y, `icon.size` token `{sm:12,md:16,lg:20}`)
