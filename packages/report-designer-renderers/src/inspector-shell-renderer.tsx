...
import type { ReportDesignerRuntimeSnapshot, ReportSelectionTarget } from '@nop-chaos/report-designer-core';
  ...
  return (
    <section className={joinClassNames('nop-report-designer', props.meta.className)} data-slot="report-designer-inspector-shell">
      ...
      {!target ? (
        ...
        <ReportInspectorRenderer {...props as any} props={{ ...props.props, body: inspector?.resolvedSchema }} />
      )}
    </section>
  );
}
