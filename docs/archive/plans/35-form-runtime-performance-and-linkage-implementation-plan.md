...
- `docs/analysis/2026-04-04-formily-vs-flux-final-report.md` 已经收敛成 Formily 对 Flux 的唯一对比入口，并且已经把实现边界收窄到“表单子域内的薄能力”，不再主张引入 Proxy 响应式、重量级字段类体系、通用 effect runtime 或全局事务系统。
