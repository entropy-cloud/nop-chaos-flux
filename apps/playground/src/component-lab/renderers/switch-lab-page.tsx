      ...
      scenarios={[
        {
          ...
          description:
            'Toggle the switch to exercise the current boolean control state. The summary text is rendered inside the form scope and updates live.',
          schema: basicSwitch,
        },
        {
          title: 'Multiple preference switches with descriptions',
          description:
            'A typical preferences panel with three switches, each with a short description below the label.',
          schema: multiSwitch,
        },
      ]}
    />
