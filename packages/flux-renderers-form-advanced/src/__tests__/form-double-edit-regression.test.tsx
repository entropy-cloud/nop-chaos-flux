...
import { buttonRenderer, env, formStateProbeRenderer, selectOption, sharedFormulaCompiler, submitCalls } from '../../../flux-renderers-form/src/test-support';
...
describe('second edit to the same field reflects updated value (bug 30 regression)', () => {
  ...
  it('tree-select: second write to the same field via form.setValue is reflected in probe', async () => {
    ...
    const SchemaRenderer = createSchemaRenderer([...allFormDefs, formStateProbeRenderer, setValueBtnRenderer]);
