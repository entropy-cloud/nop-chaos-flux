...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| W1  | abort() 不重置 `processingState`/`abortController`（:509-519）；clear/setMessages 不 null controller（:145-150/:528-533）；窗口期二次 abort 把 clear()/idle 状态 clobber 回 'aborted' | watch-only residual | 触发：abort→(clear 或 setMessages)→再 abort 的窄窗口；自愈：陈旧轮 finally 身份守卫清理；新 turn 覆盖。低严重度，不阻塞 closure。**I6 复查（2026-08-09，plan `2026-08-09-2229-1` Phase 1 临时 vitest 实证复跑 3/3，临时文件已删零残留）**：K2 已收敛 generator 残留面，controller/processingState 窗口仍在——`abort→(clear | setMessages)→再 abort`时序下二次 abort 仍把 idle clobber 回`'aborted'`（abortController 残留非空），两路径均复现；陈旧轮 unwind 后 finally 身份守卫将 controller 归 null（自愈面收敛，无永久泄漏）。维持 watch-only |
