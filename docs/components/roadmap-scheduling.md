...
| ID    | Status   | 内容                                                                                                                                                                                        | 设计文档 | 依赖   |
| ----- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ------ |
| S10.1 | proposed | **Gantt 测试页面**：apps/playground/src/pages/gantt-demo.tsx——任务网格、时间线、缩放、拖拽交互演示，注册到 playground domain 路由 gantt                                                     | —        | S1, S2 |
...
| S10.3 | proposed | **Kanban 测试页面**：apps/playground/src/pages/kanban-demo.tsx——列/卡片渲染、拖拽跨列排序、过滤搜索、增删列/卡片演示，注册到 playground domain 路由 kanban                                  | —        | S6, S7 |
