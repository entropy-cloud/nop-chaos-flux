...
export const FORM_RENDERER_ROUTES: RendererRouteEntry[] = [
  ...
  { id: 'input-tree', title: 'Input Tree', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form-advanced', description: 'Inline tree selector with checkbox and radio modes.' },
  { id: 'tree-select', title: 'Tree Select', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form-advanced', description: 'Popover-based tree selector with search support.' },
  { id: 'tag-list', title: 'Tag List', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form-advanced', description: 'Editable list of free-text tags.' },
  ...
  { id: 'detail-field', title: 'Detail Field', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form-advanced', description: 'Opens a dialog form to edit a nested object field; writes back on confirm.' },
  { id: 'detail-view', title: 'Detail View', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form-advanced', description: 'Read-only display of a nested object; expands to a dialog for inline editing.' },
];
