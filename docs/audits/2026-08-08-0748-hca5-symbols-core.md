...
| P3-1 | P3       | `compound.ts:28-47`                                                       | `deepMergeInstanceProps` 无递归深度上限（equality.ts 有对应守卫，merge 路径缺）                                                                                                                                           | residual-adjudicated at HCA-CR（watch-only；validate MAX_VALIDATE_DEPTH=100 已守，Successor: no）                                                                                                                                                                    |
