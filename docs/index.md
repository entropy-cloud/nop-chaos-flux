...
| Work on compiler package boundaries, schema compile/validate ownership, or action precompile placement                                                                                 | `docs/plans/122-compiler-package-extraction-and-boundary-plan.md`                  | `docs/architecture/schema-file-validator.md`, `docs/architecture/flux-runtime-module-boundaries.md`                                                               |
