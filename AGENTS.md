...
| ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| **Introduce a new renderer or new renderer package**                                  | `docs/references/new-renderer-introduction-audit.md`                          | `docs/references/complex-component-design-process.md`, `docs/references/renderer-implementation-guidelines.md`                          |
...
| **Extend `RendererEnv` / add new IO type / implement host fetcher/stream/openSocket** | `docs/architecture/renderer-env.md`                                           | `docs/references/new-renderer-introduction-audit.md` (INV-1/INV-2), `docs/discussions/2026-07-21-env-stream-and-websocket-extension.md` |
| Write Flux JSON schema or look up component JSON fields                               | `flux-guide/README.md`                                                        | `flux-guide/01-quickstart.md`, or the topic file under `flux-guide/` matching the component type                                        |
