...
- Reworked the temporary Flow Designer review note into `docs/analysis/2026-03-21-flow-designer-documentation-review.md` and moved the accepted conclusions into the active flow-designer docs.
