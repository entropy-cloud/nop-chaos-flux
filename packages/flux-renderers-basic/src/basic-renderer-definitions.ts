...
export const basicRendererDefinitions: RendererDefinition[] = [
  {
    ...
    fields: [
      ...
      { key: 'asideResizable', kind: 'prop', valueType: 'boolean' },
      { key: 'asideMinWidth', kind: 'prop' },
      { key: 'asideMaxWidth', kind: 'prop' },
      { key: 'asideSticky', kind: 'prop', valueType: 'boolean' },
      { key: 'modalContainer', kind: 'prop' },
      { key: 'statusPath', kind: 'prop' },
      { key: 'asideClassName', kind: 'prop' },
