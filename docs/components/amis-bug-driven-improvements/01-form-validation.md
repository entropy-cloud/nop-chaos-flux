...
| V15 | When a pattern rule fails and an author message exists, the rendered error is the author's message — never the raw regex source.                                                                                                   | TEST-GAP   | P2       | #2013, #3077 — **RESOLVED (B7)**: covered-by B1.2 `validation-rule-semantics.test.ts` (V15)                                                                                    |
