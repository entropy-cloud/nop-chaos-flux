...
| -------- | -------------------------------------------------------------------------------------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ---------------- |
| D0       | 产品标准基线（fixture 设计与 typography 决策）                                                                 | `todo` | `docs/analysis/2026-08-23-ai-widgets-vs-tiny-robot-comparison.md` §6-§7                                                                                               | —        | _(待 plan 起草)_ |
| D1       | Mock Connector 富 markdown Fixture（含 11 种元素 + 6 preset + 关键词分发 + env 工厂 option 化）                | `todo` | `apps/playground/src/ai/mock-ai-env.ts`、`apps/playground/src/ai/ai-widgets-fixture.ts`（新）                                                                         | D0       | _(待 plan 起草)_ |
| D2       | Markdown Typography 自定义 CSS（取代 `prose`）                                                                 | `todo` | `packages/flux-renderers-ai/src/renderers/ai-bubble/renderers/markdown.tsx` + `styles.css`                                                                            | D0       | _(待 plan 起草)_ |
