...
| **技术代差** | React 19 + Zustand 5 + Vite 8 + TypeScript 6.0 strict + TailwindCSS 4.1 |
...
| **ActionScope 命名空间隔离** | 局部 action-scope 边界注册命名空间    | designer:_, spreadsheet:_, report-designer:\*                             |
