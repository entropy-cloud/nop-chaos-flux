...
export function createMockDatabase(): MockDatabase {
  ...
  const sundialTasks: SundialTask[] = [
  ...
  const sundialSubtasks: SundialSubtask[] = [
    { id: 1, taskId: 1, title: '收集销售数据', done: true },
    { id: 2, taskId: 1, title: '整理发票', done: false },
    { id: 3, taskId: 6, title: '撰写结论部分', done: false },
  ];

  return { depts, tags, users, orders, orderItems, orderLogs, addresses, budgets, payments, shipments, approvalTasks, sundialTasks, sundialSubtasks };
}
