...
| Understand Flux's top-level frontend programming model, primitive categories, and base tree + coordination/execution layering | `docs/architecture/frontend-programming-model-v3.md` | `docs/architecture/flux-core.md` |
...
- `docs/architecture/frontend-programming-model-v3.md`
