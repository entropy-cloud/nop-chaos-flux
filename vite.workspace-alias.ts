...
export const workspacePackageAliases = {
  ...
  '@nop-chaos/flux-renderers-mobile/styles.css': fileURLToPath(
    new URL('./packages/flux-renderers-mobile/src/styles.css', import.meta.url),
  ),
  ...
  '@nop-chaos/flux-renderers-content/styles.css': fileURLToPath(
    new URL('./packages/flux-renderers-content/src/styles.css', import.meta.url),
  ),
  '@nop-chaos/flux-renderers-content': fileURLToPath(
    new URL('./packages/flux-renderers-content/src/index.ts', import.meta.url),
  ),
  ...
  '@nop-chaos/flux-renderers-layout/styles.css': fileURLToPath(
    new URL('./packages/flux-renderers-layout/src/styles.css', import.meta.url),
  ),
  '@nop-chaos/flux-renderers-layout': fileURLToPath(
    new URL('./packages/flux-renderers-layout/src/index.ts', import.meta.url),
  ),
  ...
  '@nop-chaos/flux-renderers-graph/styles.css': fileURLToPath(
    new URL('./packages/flux-renderers-graph/src/styles.css', import.meta.url),
  ),
  '@nop-chaos/flux-renderers-graph': fileURLToPath(
    new URL('./packages/flux-renderers-graph/src/index.ts', import.meta.url),
  ),
  '@nop-chaos/flux-renderers-3d': fileURLToPath(
    new URL('./packages/flux-renderers-3d/src/index.ts', import.meta.url),
  ),
  ...
  '@nop-chaos/flux-renderers-map': fileURLToPath(
    new URL('./packages/flux-renderers-map/src/index.ts', import.meta.url),
  ),
