...
describe('tree controls - DOM structure, markers, and expand/collapse', () => {
  it('lets FieldFrame own tree control field chrome while tree controls publish control slots', async () => {
    ...
    render(
      <SchemaRenderer
        schemaUrl="test://flux-renderers-form-advanced/__tests__/tree-structure.test.tsx#1"
        schema={
          {
            type: 'form',
            body: [
  ...
  it('publishes tree search and popover option structure through data-slot markers', async () => {
    ...
    render(
      <SchemaRenderer
        schemaUrl="test://flux-renderers-form-advanced/__tests__/tree-structure.test.tsx#2"
        schema={
          {
            type: 'form',
            body: [
  ...
  it('collapses and expands input-tree child nodes via the chevron toggle', async () => {
    ...
    render(
      <SchemaRenderer
        schemaUrl="test://flux-renderers-form-advanced/__tests__/tree-structure.test.tsx#3"
        schema={
          {
            type: 'form',
            body: [
  ...
  it('collapses and expands tree-select child nodes via the chevron toggle', async () => {
    ...
    render(
      <SchemaRenderer
        schemaUrl="test://flux-renderers-form-advanced/__tests__/tree-structure.test.tsx#4"
        schema={
          {
            type: 'form',
            body: [
  ...
  it('renders input-tree with correct data-depth and data-slot markers on option nodes', async () => {
    ...
    render(
      <SchemaRenderer
        schemaUrl="test://flux-renderers-form-advanced/__tests__/tree-structure.test.tsx#5"
        schema={
          {
            type: 'form',
            body: [
