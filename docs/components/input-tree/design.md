...
| `enableNodePath`+`pathSeparator`（值作为路径串）                                                                     | **已实现**（TR7）                                                                                                                                                                                    | —                                                               | 选中节点的值替换为从根到该节点的路径串（各段为 valueField 值，`pathSeparator` 默认为 `/`）。单选时 value 为路径字符串，多选时数组每项为路径串。`hideRoot`/`rootLabel` 暂不实现。                                                               |
| `hideRoot`/`rootLabel`                                                                                               | **暂不实现**                                                                                                                                                                                         | —                                                               | 后续按需                                                                                                                                                                                                                                       |
