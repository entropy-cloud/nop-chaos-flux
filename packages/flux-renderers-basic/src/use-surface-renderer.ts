...
import { publishOwnerStatus, useCurrentComponentRegistry, useResolvedContainer } from '@nop-chaos/flux-react';
...
export function useSurfaceRenderer(props: RendererComponentProps<DialogSchema>, kind: 'dialog'): {
  summary: SurfaceStatusSummary;
  containerElement: ReturnType<typeof useResolvedContainer>;
  handleOpenChange: (nextOpen: boolean) => void;
};
export function useSurfaceRenderer(props: RendererComponentProps<DrawerSchema>, kind: 'drawer'): {
  summary: SurfaceStatusSummary;
  containerElement: ReturnType<typeof useResolvedContainer>;
  handleOpenChange: (nextOpen: boolean) => void;
};
