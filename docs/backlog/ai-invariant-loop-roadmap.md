...
> 唯一动态状态区。Cycle 1：I0/I1 已 `✅`、I2-I6 仍 `todo`（I2 plan 已 draft active，见 `docs/plans/2026-08-09-1826-3-i2-invariant-driven-audit.md`）。后续 Cycle 按「Loop Rule」由 I6 自动派生（标记 `Cycle N`，附触发证据），不需人工重开。
