...
> Last Updated: 2026-07-27 (R1.0 expander completed — arm-index findings linked to R1.1–R1.10)
...
| MA6-P1-001   | P1       | docs/architecture/field-frame.md                   | FieldFrame render structure sketch severely outdated (missing ARIA, focus tracking, rootTag)         | `arm-MA6-doc-contract.md`                       | open   | Pending MR3 |
| MA6-P1-002   | P1       | docs/architecture/form-validation.md               | FieldFrame described using wrong hook names (selectCurrentFormFieldState → useCurrentFormFieldState) | `arm-MA6-doc-contract.md`                       | open   | Pending MR3 |
| MA6-P1-003   | P1       | docs/architecture/object-field.md                  | transformInAction/transformOutAction claim of "已接线" only partially true                           | `arm-MA6-doc-contract.md`                       | open   | Pending MR3 |
| MA6-P1-004   | P1       | docs/architecture/array-field.md                   | sortable schema-declared but never runtime-wired in renderer                                         | `arm-MA6-doc-contract.md`                       | open   | Pending MR3 |
| MA6-P1-005   | P1       | docs/architecture/module-cache-and-import-stack.md | ImportStack.push() parameters differ significantly from documented interface                         | `arm-MA6-doc-contract.md`                       | open   | Pending MR3 |
...
| MA7-XSS-P2-01   | P2       | flux-renderers-ai            | `ai-citations.tsx` `source.url`渲染为`<a href>`未过滤`javascript:` scheme                                                 | `arm-MA7-security-style-performance.md`        | open   | Pending MR3 |
| MA7-STY-P2-01   | P2       | flux-renderers-mobile        | 12个bare `[data-slot]`选择器（已在MA3-P2-F2记录）                                                                         | `arm-MA7-security-style-performance.md`        | open   | Pending MR2 |
| MA7-ASYNC-P2-01 | P2       | word-editor-core             | `document-io.ts` 4处`catch (error)`未路由到结构化失败路径                                                                 | `arm-MA7-security-style-performance.md`        | open   | Pending MR3 |
