...
import exampleSchema from '../ai/ai-component-handle-example.json';
...
/**
 * P2 demo: Layer C ComponentHandle. The `ai-chat` registers a handle addressable
 * by `componentId`; an external sibling button dispatches
 * `component:sendMessage` to drive the chat imperatively.
 */
export function AiComponentHandleDemoPage({ onBack }: Props) {
  ...
  return (
    <div className="nop-theme-root min-h-screen flex flex-col">
      ...
      <header className="flex items-center gap-3 p-3 border-b bg-background">
        ...
        <h1 className="text-lg font-semibold">AI ComponentHandle — Layer C</h1>
      </header>
      <main className="flex-1 p-4">
        <SchemaRenderer
          schemaUrl="playground://pages/ai-component-handle-demo"
