...
| Author any roadmap + mission with diagnose-first shape selection (linear vs continuous loop) and mandatory independent consensus-review rounds | `docs/skills/roadmap-and-mission-authoring-with-consensus-review.md`                                                                             |
