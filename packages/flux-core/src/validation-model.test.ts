...
describe('validation-model', () => {
  ...
  describe('buildCompiledFormValidationModel', () => {
    ...
    it('returns undefined when all nodes are form kind', () => {
      ...
      expect(buildCompiledFormValidationModel({ behavior: defaultBehavior, nodes })).toBeUndefined();
    });
  ...
  describe('getCompiledValidationRootPath', () => {
    ...
    it('returns rootPath from model', () => {
      ...
      const model = buildCompiledFormValidationModel({ behavior: defaultBehavior, nodes, rootPath: 'a' });
  ...
  describe('hasCompiledValidationNodes', () => {
    ...
    it('returns false when nodes is empty', () => {
      expect(hasCompiledValidationNodes({ order: [], behavior: defaultBehavior, dependents: {}, nodes: {} })).toBe(false);
    });
    ...
    it('returns false when nodes is undefined', () => {
      expect(hasCompiledValidationNodes({ order: [], behavior: defaultBehavior, dependents: {} })).toBe(false);
    });
  });
});
