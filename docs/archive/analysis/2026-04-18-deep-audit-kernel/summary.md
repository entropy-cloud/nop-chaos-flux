...
- 执行的维度：全部 18 个维度
- 覆盖的包：flux-core、flux-formula、flux-runtime、flux-react（核心）；维度 09-12、18 自然覆盖 flux-renderers-_、flow-designer-_、spreadsheet-_、report-designer-_、word-editor-\*、nop-debugger
- 审核日期：2026-04-18
...
| 15  | 10   | flow-designer-nodes.css        | ~25+ BEM \_\_/-- 违规（playground）                          |
