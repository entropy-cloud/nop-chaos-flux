export type RendererCategory = 'layout' | 'content' | 'actions' | 'logic' | 'advanced' | 'form' | 'data' | 'domain';
...
export const BASIC_RENDERER_ROUTES: RendererRouteEntry[] = [
  { id: 'page', title: 'Page', category: 'layout', sourcePackage: '@nop-chaos/flux-renderers-basic', description: 'Root page container with header, body, and footer regions.' },
  { id: 'container', title: 'Container', category: 'layout', sourcePackage: '@nop-chaos/flux-renderers-basic', description: 'Generic layout container with body, header, and footer regions.' },
  { id: 'fragment', title: 'Fragment', category: 'layout', sourcePackage: '@nop-chaos/flux-renderers-basic', description: 'Scope-isolated fragment; optionally injects extra data into child scope.' },
  { id: 'flex', title: 'Flex', category: 'layout', sourcePackage: '@nop-chaos/flux-renderers-basic', description: 'Flexbox container for horizontal or vertical child layout.' },
  { id: 'dialog', title: 'Dialog', category: 'layout', sourcePackage: '@nop-chaos/flux-renderers-basic', description: 'Modal dialog with body and actions regions.' },
  { id: 'drawer', title: 'Drawer', category: 'layout', sourcePackage: '@nop-chaos/flux-renderers-basic', description: 'Side-panel drawer with body and actions regions.' },
...
export const FORM_RENDERER_ROUTES: RendererRouteEntry[] = [
  { id: 'form', title: 'Form', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Root form container; manages field values, validation, and submit lifecycle.' },
  { id: 'input-text', title: 'Input Text', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Single-line text input bound to a form field.' },
  ...
  { id: 'checkbox-group', title: 'Checkbox Group', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Multi-choice checkbox group; options from schema or async source.' },
  { id: 'input-tree', title: 'Input Tree', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Inline tree selector with checkbox and radio modes.' },
  { id: 'tree-select', title: 'Tree Select', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Popover-based tree selector with search support.' },
  { id: 'tag-list', title: 'Tag List', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Editable list of free-text tags.' },
  { id: 'key-value', title: 'Key Value', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Editable list of key-value pairs.' },
  { id: 'array-editor', title: 'Array Editor', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Structured array editor with per-item column fields and add/remove controls.' },
  { id: 'condition-builder', title: 'Condition Builder', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Visual AND/OR condition tree builder with nested groups.' },
  { id: 'object-field', title: 'Object Field', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Inline composite field editing a nested object scope.' },
  { id: 'array-field', title: 'Array Field', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Inline composite array editing with per-item form regions.' },
  { id: 'variant-field', title: 'Variant Field', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Discriminated union field that switches schema based on a type selector.' },
  { id: 'detail-field', title: 'Detail Field', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Opens a dialog form to edit a nested object field; writes back on confirm.' },
  { id: 'detail-view', title: 'Detail View', category: 'form', sourcePackage: '@nop-chaos/flux-renderers-form', description: 'Read-only display of a nested object; expands to a dialog for inline editing.' },
];
...
export function buildRoute(spec: RouteSpec): string {
  switch (spec.kind) {
    case 'home': return '#/';
    case 'lab': return '#/lab';
    case 'lab-renderer': return `#/lab/${spec.rendererId}`;
    case 'domain': return `#/${spec.domainId}`;
  }
}
