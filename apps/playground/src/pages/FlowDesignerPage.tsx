  ...
  nodeTypes: [
    {
      ...
      icon: '▶',
      body: { type: 'text', text: 'Workflow start node' },
    ...
    },
    {
      ...
      icon: '■',
      body: { type: 'text', text: 'Workflow end node' },
    ...
    },
    {
      ...
      icon: '◇',
      body: { type: 'text', text: 'Condition node' },
    ...
    },
    {
      ...
      icon: '⫼',
      body: { type: 'text', text: 'Parallel node' },
