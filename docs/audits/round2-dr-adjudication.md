...
| 分类     | 条数  | 说明                                                                                     |
| -------- | ----- | ---------------------------------------------------------------------------------------- |
| P2 路由  | 6     | DR-1/DR-2（fd-7/fd-2 i18n）+ DR-3–DR-6（ss-2 ×2 / ss-4 / ss-9 i18n 与死管线，D3.2 追加） |
| 卡内 P3  | 18    | 卡内记录不路由（fd-1..fd-12 ×9 + ss-1..ss-10 各卡 P3，D3.2 追加 9 条）                   |
| **合计** | **6** | 与 13 卡 + 10 卡发现清单逐条对齐（卡内 P2 零悬挂）                                       |
...
- 本表零悬挂声明：13 卡 P2 清单（fd-2 P2-1 / fd-7 P2-1）+ 10 卡 P2 清单（ss-1 P2-1 当场修复不路由 / ss-2 P2-1、P2-2 → DR-3、DR-4 / ss-4 P2-1 → DR-5 / ss-8 P2-1 当场修复不路由 / ss-9 P2-1 → DR-6）已全部登记，卡内无未登记 P2。
