      ...
      body: [
        ...
        },
        {
          ...
          config: {
            ...
            symbols: [
              { id: 'pipe-in-1', type: 'scada-pipe', x: 0, y: 232, width: 64, height: 0 },
              {
                id: 'level-1',
              ...
              { id: 'pipe-level-pump', type: 'scada-pipe', x: 124, y: 232, width: 84, height: 0 },
              {
                id: 'pump-1',
              ...
              { id: 'pipe-pump-valve', type: 'scada-pipe', x: 264, y: 232, width: 112, height: 0 },
              {
                id: 'valve-1',
              ...
              { id: 'pipe-valve-junc', type: 'scada-pipe', x: 440, y: 232, width: 88, height: 0 },
              {
                id: 'junction-1',
              ...
              { id: 'pipe-junc-gauge', type: 'scada-pipe', x: 608, y: 232, width: 72, height: 0 },
              {
                id: 'gauge-1',
              ...
              { id: 'text-title', type: 'scada-text', x: 40, y: 24, text: '工艺流程组态演示（I13.1）', textSize: 18, textColor: '#0d47a1' },
              { id: 'text-level', type: 'scada-text', x: 56, y: 240, text: '储水罐 LT-101', textSize: 11, textColor: '#37474f' },
              { id: 'text-pump', type: 'scada-text', x: 200, y: 264, text: '给水泵 P-101', textSize: 11, textColor: '#37474f' },
              { id: 'text-valve', type: 'scada-text', x: 376, y: 256, text: '调节阀 V-101', textSize: 11, textColor: '#37474f' },
              { id: 'text-gauge', type: 'scada-text', x: 696, y: 300, text: '流量计 FI-201', textSize: 11, textColor: '#37474f' },
              { id: 'text-motor', type: 'scada-text', x: 368, y: 112, text: '搅拌电机 M-101', textSize: 11, textColor: '#37474f' },
              { id: 'text-fan', type: 'scada-text', x: 544, y: 112, text: '冷却风机 F-101', textSize: 11, textColor: '#37474f' },
              { id: 'text-temp', type: 'scada-text', x: 600, y: 440, text: '温度 TE-201', textSize: 11, textColor: '#37474f' },
              { id: 'text-tip', type: 'scada-text', x: 40, y: 440, text: '单击设备 → 详情；双击电机 → 跳转 flux-basic；单击按钮 → 数据请求', textSize: 11, textColor: '#546e7a' },
            ],
          },
