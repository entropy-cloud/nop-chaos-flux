...
结合 `docs/analysis/2026-04-04-nop-chaos-flux-comparison-report.md`、`docs/architecture/flux-core.md`、`docs/architecture/flux-dsl-vm-extensibility.md`、`docs/architecture/complex-control-host-protocol.md`、`docs/architecture/api-data-source.md`、`docs/architecture/flow-designer/runtime-snapshot.md` 以及子 agent 调研结果，可以得到如下结论。
...
- 它在运行时抽象上也更完整：统一值语义、全值树编译、`ScopeRef / ActionScope / ComponentHandleRegistry` 三套正交结构、字段元数据驱动编译，这些都不是一般 schema form engine 会认真解决的问题，见 `docs/architecture/flux-core.md`、`docs/analysis/2026-04-04-nop-chaos-flux-comparison-report.md`。
