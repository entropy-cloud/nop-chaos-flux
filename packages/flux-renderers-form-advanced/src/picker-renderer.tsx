...
import { Button, Empty, Input, cn } from '@nop-chaos/ui';
...
function createPickerCrudSchema(args: {
  ...
  return {
    ...
    loadAction: args.loadAction as ActionSchema | undefined,
...
export function PickerRenderer(props: RendererComponentProps<PickerSchema>) {
  ...
  const openDialog = React.useCallback(() => {
    ...
    setOpen(true);
  }, [crudMode, env, hasPickerDialog, options.length, selectedValues]);
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent data-slot="picker-dialog-content">
          ...
          <DialogFooter>
            ...
            <Button type="button" size="sm" data-slot="picker-confirm" onClick={confirmSelection}>
