...
describe('checkbox-group values and scope-debug', () => {
  it('preserves non-string checkbox-group values in form state and submit payloads', async () => {
    ...
    render(
      <SchemaRenderer
        schemaUrl="test://flux-renderers-form-advanced/__tests__/form-checkbox-scope-debug.test.tsx#1"
        schema={
          {
            type: 'form',
            data: {
  ...
  it('preserves checkbox-group values when updating plain scope data', () => {
    ...
    render(
      <SchemaRenderer
        schemaUrl="test://flux-renderers-form-advanced/__tests__/form-checkbox-scope-debug.test.tsx#2"
        schema={
          [
            {
              type: 'checkbox-group',
  ...
  it('lets scope-debug see full form data and rerender when form values change', async () => {
    ...
    render(
      <SchemaRenderer
        schemaUrl="test://flux-renderers-form-advanced/__tests__/form-checkbox-scope-debug.test.tsx#3"
        schema={{
          type: 'form',
          data: {
            summary: {
