...
| 3 | `getByTestId` | 没有角色/标签的业务数据节点 | `getByTestId('form-state:flags')` |
| 4 | 语义 class + `closest()` | renderer 结构定位 | `input.closest('.nop-field')` |
| 5 | `data-*` 属性 | 状态断言 | `el.hasAttribute('data-field-dirty')` |
